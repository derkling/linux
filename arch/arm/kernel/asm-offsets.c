...
int main(void)
{
  ...
  DEFINE(BL_SYNC_CLUSTER_FIRST_MAN, offsetof(struct bL_cluster_sync_struct, first_man));
  DEFINE(BL_SYNC_CLUSTER_CPUS, offsetof(struct bL_cluster_sync_struct, cpus));
  DEFINE(BL_SYNC_CLUSTER_CLUSTER, offsetof(struct bL_cluster_sync_struct, cluster));
  DEFINE(BL_SYNC_CLUSTER_INBOUND, offsetof(struct bL_cluster_sync_struct, inbound));
  return 0; 
}
