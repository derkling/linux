...
#else  /* CONFIG_ARCH_VEXPRESS_LT_ELBA || CONFIG_ARCH_TUSCAN */
#define IRQ_VEXPRESS_PCIE_A		(IRQ_ARM_VEXPRESS_GIC_START + 26)	/* PCI Express INTA */
#define IRQ_VEXPRESS_PCIE_B		(IRQ_ARM_VEXPRESS_GIC_START + 27)	/* PCI Express INTB */
...
#else /* CONFIG_ARCH_VEXPRESS_LT_ELBA || CONFIG_ARCH_TUSCAN */
#define IRQ_VEXPRESS_MSI_IN_1		(IRQ_ARM_VEXPRESS_GIC_START + 16)	/* PCI Express MSI interrupt */
...
#else /* CONFIG_ARCH_VEXPRESS_LT_ELBA || CONFIG_ARCH_TUSCAN */
#define IRQ_VEXPRESS_PMU_CPU0	(IRQ_ARM_VEXPRESS_GIC_START + 36)	/* CPU PMU Interrupts */
#define IRQ_VEXPRESS_PMU_CPU1	(IRQ_ARM_VEXPRESS_GIC_START + 37)
#endif
