...
#ifdef CONFIG_HOTPLUG_CPU
static int omap_wakegen_cpu_online(unsigned int cpu)
{
	wakeupgen_irqmask_all(cpu, 0);
	return 0;
}

static int omap_wakegen_cpu_dead(unsigned int cpu)
{
...
{
	cpuhp_setup_state_nocalls(CPUHP_ARM_OMAP_WAKE_ONLINE,
				  omap_wakegen_cpu_online, NULL);
	cpuhp_setup_state_nocalls(CPUHP_ARM_OMAP_WAKE_DEAD, NULL,
				  omap_wakegen_cpu_dead);
