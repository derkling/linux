...
static __init int hpet_late_init(void)
{
	...
	ret = cpuhp_setup_state(CPUHP_X86_HPET_ONLINE, hpet_cpuhp_online, NULL);
	if (ret)
		return ret;
	ret = cpuhp_setup_state(CPUHP_X86_HPET_DEAD, NULL, hpet_cpuhp_dead);
	if (ret)
		goto err_cpuhp;
	return 0;

err_cpuhp:
	cpuhp_remove_state(CPUHP_X86_HPET_ONLINE);
	return ret;
}
