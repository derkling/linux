...
#else
#define trace_sched_uclamp_se(p) while(false) {}
#define trace_sched_uclamp_rt(rq) while(false) {}
#define trace_sched_uclamp_cfs(rq) while(false) {}
