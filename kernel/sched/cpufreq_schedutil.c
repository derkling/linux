 ...
 * maximum one.
 */
static void sugov_iowait_init(struct sugov_cpu *sg_cpu, u64 time,
				   unsigned int flags)
{
 ...
 * sugov_iowait_init(), and it's instead decreased by this function,
				...
				unsigned int flags)
{
	...
	sugov_iowait_init(sg_cpu, time, flags);
