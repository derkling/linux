...
/*
 * Allowed minimum utilization for FAIR tasks
 * default: 1024
 */
unsigned int sysctl_sched_uclamp_util_min = SCHED_CAPACITY_SCALE;

/*
 * Allowed maximum utilization for FAIR tasks
 * default: 1024
 */
 ...
 * task's uclamp::bucket_id is reference counted on that CPU. This also
			 ...
			 loff_t *ppos)
{
	...
	/*
	 * Updating all the RUNNABLE task is expesing.
	 * Keep it simple and do just a lazy update at their next activation.
	 */
	goto done;
