...
// static unsigned int stune_cap_max(unsigned int cpu)
// {
...
//
// 	return task_group(tsk)->capacity_max;
// }
...
// static unsigned int stune_cap_min(unsigned int cpu)
// {
// 	struct task_struct *tsk;
// 	struct rb_node *node;
//
...
//
// 	return task_group(tsk)->capacity_min;
// }
		...
		struct task_struct *p, unsigned int cpu)
{
	...
	if (update_cache) {
		...
		trace_printk("stune_nq_update: cpu=%d min=%llu",
				cpu, capacity_new);
	}
}
		...
		struct task_struct *p, unsigned int cpu)
{
	...
	if (update_cache) {
		...
		trace_printk("stune_nq_update: cpu=%d max=%llu",
				cpu, capacity_new);
	}
