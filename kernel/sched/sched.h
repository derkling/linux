 ...
 */
struct uclamp_group {
	unsigned long value : bits_for(SCHED_CAPACITY_SCALE);
	unsigned long tasks : BITS_PER_LONG - bits_for(SCHED_CAPACITY_SCALE);
};
...
struct uclamp_cpu {
	unsigned int value;
	struct uclamp_group group[UCLAMP_GROUPS];
};
