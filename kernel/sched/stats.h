...
/*
 * Called after sched_info_switch and latency information already traced for
 * the task departing from the CPU. We are only called when prev != next.
 */
static inline void
