...
static __read_mostly unsigned int walt_new_task_windows = 5;
...
static bool is_new_task(struct task_struct *p)
{
	return p->ravg.active_windows < walt_new_task_windows;
}
