...
static int cpu_util_wake(int cpu, struct task_struct *p)
{
	 ...
	 */
	/* here we need the real util_est, not the value which
	 * might already be cpu_util.
	 */
