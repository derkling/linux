...
#define CPU_DVFS_FREQ00_LL_FY	(1391000)	/* KHz */
#define CPU_DVFS_FREQ01_LL_FY	(1339000)	/* KHz */
#define CPU_DVFS_FREQ02_LL_FY	(1287000)	/* KHz */
#define CPU_DVFS_FREQ03_LL_FY	(1222000)	/* KHz */
#define CPU_DVFS_FREQ04_LL_FY	(1118000)	/* KHz */
#define CPU_DVFS_FREQ05_LL_FY	(1092000)	/* KHz */
#define CPU_DVFS_FREQ06_LL_FY	(949000)	/* KHz */
#define CPU_DVFS_FREQ07_LL_FY	(897000)	/* KHz */
#define CPU_DVFS_FREQ08_LL_FY	(806000)	/* KHz */
#define CPU_DVFS_FREQ09_LL_FY	(715000)	/* KHz */
...
#define CPU_DVFS_FREQ00_L_FY	(1846000)	/* KHz */
#define CPU_DVFS_FREQ01_L_FY	(1781000)	/* KHz */
#define CPU_DVFS_FREQ02_L_FY	(1703000)	/* KHz */
#define CPU_DVFS_FREQ03_L_FY	(1625000)	/* KHz */
#define CPU_DVFS_FREQ04_L_FY	(1495000)	/* KHz */
#define CPU_DVFS_FREQ05_L_FY	(1417000)	/* KHz */
#define CPU_DVFS_FREQ06_L_FY	(1274000)	/* KHz */
#define CPU_DVFS_FREQ07_L_FY	(1209000)	/* KHz */
#define CPU_DVFS_FREQ08_L_FY	(1092000)	/* KHz */
#define CPU_DVFS_FREQ09_L_FY	(949000)	/* KHz */
...
#define CPU_DVFS_FREQ00_CCI_FY	(923000)	/* KHz */
#define CPU_DVFS_FREQ01_CCI_FY	(884000)	/* KHz */
#define CPU_DVFS_FREQ02_CCI_FY	(858000)	/* KHz */
#define CPU_DVFS_FREQ03_CCI_FY	(819000)	/* KHz */
#define CPU_DVFS_FREQ04_CCI_FY	(754000)	/* KHz */
#define CPU_DVFS_FREQ05_CCI_FY	(715000)	/* KHz */
#define CPU_DVFS_FREQ06_CCI_FY	(637000)	/* KHz */
#define CPU_DVFS_FREQ07_CCI_FY	(611000)	/* KHz */
#define CPU_DVFS_FREQ08_CCI_FY	(533000)	/* KHz */
#define CPU_DVFS_FREQ09_CCI_FY	(481000)	/* KHz */
...
/* 1221 */
#define CPU_DVFS_FREQ00_B_FY1221	(2145000)	/* KHz */
#define CPU_DVFS_FREQ01_B_FY1221	(2093000)	/* KHz */
#define CPU_DVFS_FREQ02_B_FY1221	(2054000)	/* KHz */
#define CPU_DVFS_FREQ03_B_FY1221	(1989000)	/* KHz */
#define CPU_DVFS_FREQ04_B_FY1221	(1963000)	/* KHz */
#define CPU_DVFS_FREQ05_B_FY1221	(1872000)	/* KHz */
#define CPU_DVFS_FREQ06_B_FY1221	(1690000)	/* KHz */
#define CPU_DVFS_FREQ07_B_FY1221	(1599000)	/* KHz */
#define CPU_DVFS_FREQ08_B_FY1221	(1404000)	/* KHz */
#define CPU_DVFS_FREQ09_B_FY1221	(1287000)	/* KHz */
...
#define CPU_IDVFS_FREQ00_B_FY1221	(8580)		/* Perc */
#define CPU_IDVFS_FREQ01_B_FY1221	(8372)		/* Perc */
#define CPU_IDVFS_FREQ02_B_FY1221	(8216)		/* Perc */
#define CPU_IDVFS_FREQ03_B_FY1221	(7956)		/* Perc */
#define CPU_IDVFS_FREQ04_B_FY1221	(7852)		/* Perc */
#define CPU_IDVFS_FREQ05_B_FY1221	(7488)		/* Perc */
#define CPU_IDVFS_FREQ06_B_FY1221	(6760)		/* Perc */
#define CPU_IDVFS_FREQ07_B_FY1221	(6396)		/* Perc */
#define CPU_IDVFS_FREQ08_B_FY1221	(5616)		/* Perc */
#define CPU_IDVFS_FREQ09_B_FY1221	(5148)		/* Perc */
...
/* 0119 */
#define CPU_DVFS_FREQ00_B_FY0119	(2314000)	/* KHz */
#define CPU_DVFS_FREQ01_B_FY0119	(2197000)	/* KHz */
#define CPU_DVFS_FREQ02_B_FY0119	(2171000)	/* KHz */
#define CPU_DVFS_FREQ03_B_FY0119	(2119000)	/* KHz */
#define CPU_DVFS_FREQ04_B_FY0119	(2093000)	/* KHz */
#define CPU_DVFS_FREQ05_B_FY0119	(1989000)	/* KHz */
#define CPU_DVFS_FREQ06_B_FY0119	(1781000)	/* KHz */
#define CPU_DVFS_FREQ07_B_FY0119	(1677000)	/* KHz */
#define CPU_DVFS_FREQ08_B_FY0119	(1495000)	/* KHz */
#define CPU_DVFS_FREQ09_B_FY0119	(1378000)	/* KHz */
...
#define CPU_IDVFS_FREQ00_B_FY0119	(9256)		/* Perc */
#define CPU_IDVFS_FREQ01_B_FY0119	(8788)		/* Perc */
#define CPU_IDVFS_FREQ02_B_FY0119	(8684)		/* Perc */
#define CPU_IDVFS_FREQ03_B_FY0119	(8476)		/* Perc */
#define CPU_IDVFS_FREQ04_B_FY0119	(8372)		/* Perc */
#define CPU_IDVFS_FREQ05_B_FY0119	(7956)		/* Perc */
#define CPU_IDVFS_FREQ06_B_FY0119	(7124)		/* Perc */
#define CPU_IDVFS_FREQ07_B_FY0119	(6708)		/* Perc */
#define CPU_IDVFS_FREQ08_B_FY0119	(5980)		/* Perc */
#define CPU_IDVFS_FREQ09_B_FY0119	(5512)		/* Perc */
...
#define CPU_DVFS_VOLT00_VPROC1_FY	(120000)	/* 10MV */
#define CPU_DVFS_VOLT01_VPROC1_FY	(118000)	/* 10MV */
#define CPU_DVFS_VOLT02_VPROC1_FY	(115000)	/* 10MV */
#define CPU_DVFS_VOLT03_VPROC1_FY	(113000)	/* 10MV */
#define CPU_DVFS_VOLT04_VPROC1_FY	(109000)	/* 10MV */
#define CPU_DVFS_VOLT05_VPROC1_FY	(107000)	/* 10MV */
#define CPU_DVFS_VOLT06_VPROC1_FY	(102000)	/* 10MV */
#define CPU_DVFS_VOLT07_VPROC1_FY	(100000)	/* 10MV */
#define CPU_DVFS_VOLT08_VPROC1_FY	(97000)		/* 10MV */
#define CPU_DVFS_VOLT09_VPROC1_FY	(94000)		/* 10MV */
...
/* 1221 */
#define CPU_DVFS_VOLT00_VPROC2_FY1221	(118000)	/* 10MV */
#define CPU_DVFS_VOLT01_VPROC2_FY1221	(117000)	/* 10MV */
#define CPU_DVFS_VOLT02_VPROC2_FY1221	(116000)	/* 10MV */
#define CPU_DVFS_VOLT03_VPROC2_FY1221	(114000)	/* 10MV */
#define CPU_DVFS_VOLT04_VPROC2_FY1221	(113000)	/* 10MV */
#define CPU_DVFS_VOLT05_VPROC2_FY1221	(111000)	/* 10MV */
#define CPU_DVFS_VOLT06_VPROC2_FY1221	(107000)	/* 10MV */
#define CPU_DVFS_VOLT07_VPROC2_FY1221	(105000)	/* 10MV */
#define CPU_DVFS_VOLT08_VPROC2_FY1221	(100000)	/* 10MV */
#define CPU_DVFS_VOLT09_VPROC2_FY1221	(98000)		/* 10MV */
...
/* 0119 */
#define CPU_DVFS_VOLT00_VPROC2_FY0119	(120000)	/* 10MV */
#define CPU_DVFS_VOLT01_VPROC2_FY0119	(117000)	/* 10MV */
#define CPU_DVFS_VOLT02_VPROC2_FY0119	(116000)	/* 10MV */
#define CPU_DVFS_VOLT03_VPROC2_FY0119	(114000)	/* 10MV */
#define CPU_DVFS_VOLT04_VPROC2_FY0119	(113000)	/* 10MV */
#define CPU_DVFS_VOLT05_VPROC2_FY0119	(111000)	/* 10MV */
#define CPU_DVFS_VOLT06_VPROC2_FY0119	(107000)	/* 10MV */
#define CPU_DVFS_VOLT07_VPROC2_FY0119	(105000)	/* 10MV */
#define CPU_DVFS_VOLT08_VPROC2_FY0119	(100000)	/* 10MV */
#define CPU_DVFS_VOLT09_VPROC2_FY0119	(98000)		/* 10MV */
...
#define CPU_DVFS_FREQ00_LL_SB		(1547000)	/* KHz */
#define CPU_DVFS_FREQ01_LL_SB		(1495000)	/* KHz */
#define CPU_DVFS_FREQ02_LL_SB		(1443000)	/* KHz */
#define CPU_DVFS_FREQ03_LL_SB		(1391000)	/* KHz */
#define CPU_DVFS_FREQ04_LL_SB		(1339000)	/* KHz */
#define CPU_DVFS_FREQ05_LL_SB		(1274000)	/* KHz */
#define CPU_DVFS_FREQ06_LL_SB		(1222000)	/* KHz */
#define CPU_DVFS_FREQ07_LL_SB		(1118000)	/* KHz */
#define CPU_DVFS_FREQ08_LL_SB		(1014000)	/* KHz */
#define CPU_DVFS_FREQ09_LL_SB		(897000)	/* KHz */
...
#define CPU_DVFS_FREQ00_L_SB		(2002000)	/* KHz */
#define CPU_DVFS_FREQ01_L_SB		(1950000)	/* KHz */
#define CPU_DVFS_FREQ02_L_SB		(1885000)	/* KHz */
#define CPU_DVFS_FREQ03_L_SB		(1820000)	/* KHz */
#define CPU_DVFS_FREQ04_L_SB		(1755000)	/* KHz */
#define CPU_DVFS_FREQ05_L_SB		(1703000)	/* KHz */
#define CPU_DVFS_FREQ06_L_SB		(1625000)	/* KHz */
#define CPU_DVFS_FREQ07_L_SB		(1495000)	/* KHz */
#define CPU_DVFS_FREQ08_L_SB		(1352000)	/* KHz */
#define CPU_DVFS_FREQ09_L_SB		(1209000)	/* KHz */
...
#define CPU_DVFS_FREQ00_CCI_SB		(988000)	/* KHz */
#define CPU_DVFS_FREQ01_CCI_SB		(975000)	/* KHz */
#define CPU_DVFS_FREQ02_CCI_SB		(936000)	/* KHz */
#define CPU_DVFS_FREQ03_CCI_SB		(910000)	/* KHz */
#define CPU_DVFS_FREQ04_CCI_SB		(884000)	/* KHz */
#define CPU_DVFS_FREQ05_CCI_SB		(845000)	/* KHz */
#define CPU_DVFS_FREQ06_CCI_SB		(819000)	/* KHz */
#define CPU_DVFS_FREQ07_CCI_SB		(754000)	/* KHz */
#define CPU_DVFS_FREQ08_CCI_SB		(676000)	/* KHz */
#define CPU_DVFS_FREQ09_CCI_SB		(611000)	/* KHz */
...
/* 1221 */
#define CPU_DVFS_FREQ00_B_SB1221	(2340000)	/* KHz */
#define CPU_DVFS_FREQ01_B_SB1221	(2288000)	/* KHz */
#define CPU_DVFS_FREQ02_B_SB1221	(2223000)	/* KHz */
#define CPU_DVFS_FREQ03_B_SB1221	(2145000)	/* KHz */
#define CPU_DVFS_FREQ04_B_SB1221	(2093000)	/* KHz */
#define CPU_DVFS_FREQ05_B_SB1221	(2028000)	/* KHz */
#define CPU_DVFS_FREQ06_B_SB1221	(1963000)	/* KHz */
#define CPU_DVFS_FREQ07_B_SB1221	(1781000)	/* KHz */
#define CPU_DVFS_FREQ08_B_SB1221	(1599000)	/* KHz */
#define CPU_DVFS_FREQ09_B_SB1221	(1404000)	/* KHz */
...
#define CPU_IDVFS_FREQ00_B_SB1221	(9360)		/* Perc */
#define CPU_IDVFS_FREQ01_B_SB1221	(9152)		/* Perc */
#define CPU_IDVFS_FREQ02_B_SB1221	(8892)		/* Perc */
#define CPU_IDVFS_FREQ03_B_SB1221	(8580)		/* Perc */
#define CPU_IDVFS_FREQ04_B_SB1221	(8372)		/* Perc */
#define CPU_IDVFS_FREQ05_B_SB1221	(8112)		/* Perc */
#define CPU_IDVFS_FREQ06_B_SB1221	(7852)		/* Perc */
#define CPU_IDVFS_FREQ07_B_SB1221	(7124)		/* Perc */
#define CPU_IDVFS_FREQ08_B_SB1221	(6396)		/* Perc */
#define CPU_IDVFS_FREQ09_B_SB1221	(5616)		/* Perc */
...
/* 0119*/
#define CPU_DVFS_FREQ00_B_SB0119	(2522000)	/* KHz */
#define CPU_DVFS_FREQ01_B_SB0119	(2392000)	/* KHz */
#define CPU_DVFS_FREQ02_B_SB0119	(2327000)	/* KHz */
#define CPU_DVFS_FREQ03_B_SB0119	(2262000)	/* KHz */
#define CPU_DVFS_FREQ04_B_SB0119	(2223000)	/* KHz */
#define CPU_DVFS_FREQ05_B_SB0119	(2158000)	/* KHz */
#define CPU_DVFS_FREQ06_B_SB0119	(2093000)	/* KHz */
#define CPU_DVFS_FREQ07_B_SB0119	(1885000)	/* KHz */
#define CPU_DVFS_FREQ08_B_SB0119	(1677000)	/* KHz */
#define CPU_DVFS_FREQ09_B_SB0119	(1495000)	/* KHz */
...
#define CPU_IDVFS_FREQ00_B_SB0119	(10088)		/* Perc */
#define CPU_IDVFS_FREQ01_B_SB0119	(9568)		/* Perc */
#define CPU_IDVFS_FREQ02_B_SB0119	(9308)		/* Perc */
#define CPU_IDVFS_FREQ03_B_SB0119	(9048)		/* Perc */
#define CPU_IDVFS_FREQ04_B_SB0119	(8892)		/* Perc */
#define CPU_IDVFS_FREQ05_B_SB0119	(8632)		/* Perc */
#define CPU_IDVFS_FREQ06_B_SB0119	(8372)		/* Perc */
#define CPU_IDVFS_FREQ07_B_SB0119	(7540)		/* Perc */
#define CPU_IDVFS_FREQ08_B_SB0119	(6708)		/* Perc */
#define CPU_IDVFS_FREQ09_B_SB0119	(5980)		/* Perc */
...
/* for DVFS OPP table LL|L|CCI */
#define CPU_DVFS_VOLT00_VPROC1_SB	(120000)	/* 10MV */
#define CPU_DVFS_VOLT01_VPROC1_SB	(119000)	/* 10MV */
#define CPU_DVFS_VOLT02_VPROC1_SB	(117000)	/* 10MV */
#define CPU_DVFS_VOLT03_VPROC1_SB	(115000)	/* 10MV */
#define CPU_DVFS_VOLT04_VPROC1_SB	(114000)	/* 10MV */
#define CPU_DVFS_VOLT05_VPROC1_SB	(113000)	/* 10MV */
#define CPU_DVFS_VOLT06_VPROC1_SB	(110000)	/* 10MV */
#define CPU_DVFS_VOLT07_VPROC1_SB	(107000)	/* 10MV */
#define CPU_DVFS_VOLT08_VPROC1_SB	(104000)	/* 10MV */
#define CPU_DVFS_VOLT09_VPROC1_SB	(100000)	/* 10MV */
...
/* for DVFS OPP table B */
/* 1221 */
#define CPU_DVFS_VOLT00_VPROC2_SB1221	(118000)	/* 10MV */
#define CPU_DVFS_VOLT01_VPROC2_SB1221	(117000)	/* 10MV */
#define CPU_DVFS_VOLT02_VPROC2_SB1221	(116000)	/* 10MV */
#define CPU_DVFS_VOLT03_VPROC2_SB1221	(115000)	/* 10MV */
#define CPU_DVFS_VOLT04_VPROC2_SB1221	(114000)	/* 10MV */
#define CPU_DVFS_VOLT05_VPROC2_SB1221	(113000)	/* 10MV */
#define CPU_DVFS_VOLT06_VPROC2_SB1221	(111000)	/* 10MV */
#define CPU_DVFS_VOLT07_VPROC2_SB1221	(108000)	/* 10MV */
#define CPU_DVFS_VOLT08_VPROC2_SB1221	(104000)	/* 10MV */
#define CPU_DVFS_VOLT09_VPROC2_SB1221	(100000)	/* 10MV */
...
/* 0119 */
#define CPU_DVFS_VOLT00_VPROC2_SB0119	(120000)	/* 10MV */
#define CPU_DVFS_VOLT01_VPROC2_SB0119	(117000)	/* 10MV */
#define CPU_DVFS_VOLT02_VPROC2_SB0119	(116000)	/* 10MV */
#define CPU_DVFS_VOLT03_VPROC2_SB0119	(115000)	/* 10MV */
#define CPU_DVFS_VOLT04_VPROC2_SB0119	(114000)	/* 10MV */
#define CPU_DVFS_VOLT05_VPROC2_SB0119	(113000)	/* 10MV */
#define CPU_DVFS_VOLT06_VPROC2_SB0119	(111000)	/* 10MV */
#define CPU_DVFS_VOLT07_VPROC2_SB0119	(108000)	/* 10MV */
#define CPU_DVFS_VOLT08_VPROC2_SB0119	(104000)	/* 10MV */
#define CPU_DVFS_VOLT09_VPROC2_SB0119	(100000)	/* 10MV */
...
#define CPU_DVFS_FREQ00_LL_M		(1391000)	/* KHz */
#define CPU_DVFS_FREQ01_LL_M		(1339000)	/* KHz */
#define CPU_DVFS_FREQ02_LL_M		(1287000)	/* KHz */
#define CPU_DVFS_FREQ03_LL_M		(1222000)	/* KHz */
#define CPU_DVFS_FREQ04_LL_M		(1118000)	/* KHz */
#define CPU_DVFS_FREQ05_LL_M		(1092000)	/* KHz */
#define CPU_DVFS_FREQ06_LL_M		(949000)	/* KHz */
#define CPU_DVFS_FREQ07_LL_M		(897000)	/* KHz */
#define CPU_DVFS_FREQ08_LL_M		(806000)	/* KHz */
#define CPU_DVFS_FREQ09_LL_M		(715000)	/* KHz */
...
#define CPU_DVFS_FREQ00_L_M		(1846000)	/* KHz */
#define CPU_DVFS_FREQ01_L_M		(1781000)	/* KHz */
#define CPU_DVFS_FREQ02_L_M		(1703000)	/* KHz */
#define CPU_DVFS_FREQ03_L_M		(1625000)	/* KHz */
#define CPU_DVFS_FREQ04_L_M		(1495000)	/* KHz */
#define CPU_DVFS_FREQ05_L_M		(1417000)	/* KHz */
#define CPU_DVFS_FREQ06_L_M		(1274000)	/* KHz */
#define CPU_DVFS_FREQ07_L_M		(1209000)	/* KHz */
#define CPU_DVFS_FREQ08_L_M		(1092000)	/* KHz */
#define CPU_DVFS_FREQ09_L_M		(949000)	/* KHz */
...
#define CPU_DVFS_FREQ00_CCI_M		(923000)	/* KHz */
#define CPU_DVFS_FREQ01_CCI_M		(884000)	/* KHz */
#define CPU_DVFS_FREQ02_CCI_M		(858000)	/* KHz */
#define CPU_DVFS_FREQ03_CCI_M		(819000)	/* KHz */
#define CPU_DVFS_FREQ04_CCI_M		(754000)	/* KHz */
#define CPU_DVFS_FREQ05_CCI_M		(715000)	/* KHz */
#define CPU_DVFS_FREQ06_CCI_M		(637000)	/* KHz */
#define CPU_DVFS_FREQ07_CCI_M		(611000)	/* KHz */
#define CPU_DVFS_FREQ08_CCI_M		(533000)	/* KHz */
#define CPU_DVFS_FREQ09_CCI_M		(481000)	/* KHz */
...
/* 1221 */
#define CPU_DVFS_FREQ00_B_M1221		(1950000)	/* KHz */
#define CPU_DVFS_FREQ01_B_M1221		(1898000)	/* KHz */
#define CPU_DVFS_FREQ02_B_M1221		(1859000)	/* KHz */
#define CPU_DVFS_FREQ03_B_M1221		(1807000)	/* KHz */
#define CPU_DVFS_FREQ04_B_M1221		(1768000)	/* KHz */
#define CPU_DVFS_FREQ05_B_M1221		(1677000)	/* KHz */
#define CPU_DVFS_FREQ06_B_M1221		(1495000)	/* KHz */
#define CPU_DVFS_FREQ07_B_M1221		(1404000)	/* KHz */
#define CPU_DVFS_FREQ08_B_M1221		(1274000)	/* KHz */
#define CPU_DVFS_FREQ09_B_M1221		(1170000)	/* KHz */
...
static struct mt_cpu_freq_info opp_tbl_LL_e1_0[] = {
	OP(CPU_DVFS_FREQ00_LL_FY, CPU_DVFS_VOLT00_VPROC1_FY),
	OP(CPU_DVFS_FREQ01_LL_FY, CPU_DVFS_VOLT01_VPROC1_FY),
	OP(CPU_DVFS_FREQ02_LL_FY, CPU_DVFS_VOLT02_VPROC1_FY),
	OP(CPU_DVFS_FREQ03_LL_FY, CPU_DVFS_VOLT03_VPROC1_FY),
	OP(CPU_DVFS_FREQ04_LL_FY, CPU_DVFS_VOLT04_VPROC1_FY),
	OP(CPU_DVFS_FREQ05_LL_FY, CPU_DVFS_VOLT05_VPROC1_FY),
	OP(CPU_DVFS_FREQ06_LL_FY, CPU_DVFS_VOLT06_VPROC1_FY),
	OP(CPU_DVFS_FREQ07_LL_FY, CPU_DVFS_VOLT07_VPROC1_FY),
	OP(CPU_DVFS_FREQ08_LL_FY, CPU_DVFS_VOLT08_VPROC1_FY),
	OP(CPU_DVFS_FREQ09_LL_FY, CPU_DVFS_VOLT09_VPROC1_FY),
	OP(CPU_DVFS_FREQ10_LL_FY, CPU_DVFS_VOLT10_VPROC1_FY),
	OP(CPU_DVFS_FREQ11_LL_FY, CPU_DVFS_VOLT11_VPROC1_FY),
	OP(CPU_DVFS_FREQ12_LL_FY, CPU_DVFS_VOLT12_VPROC1_FY),
	OP(CPU_DVFS_FREQ13_LL_FY, CPU_DVFS_VOLT13_VPROC1_FY),
	OP(CPU_DVFS_FREQ14_LL_FY, CPU_DVFS_VOLT14_VPROC1_FY),
	OP(CPU_DVFS_FREQ15_LL_FY, CPU_DVFS_VOLT15_VPROC1_FY),
};

static struct mt_cpu_freq_info opp_tbl_L_e1_0[] = {
	OP(CPU_DVFS_FREQ00_L_FY, CPU_DVFS_VOLT00_VPROC1_FY),
	OP(CPU_DVFS_FREQ01_L_FY, CPU_DVFS_VOLT01_VPROC1_FY),
	OP(CPU_DVFS_FREQ02_L_FY, CPU_DVFS_VOLT02_VPROC1_FY),
	OP(CPU_DVFS_FREQ03_L_FY, CPU_DVFS_VOLT03_VPROC1_FY),
	OP(CPU_DVFS_FREQ04_L_FY, CPU_DVFS_VOLT04_VPROC1_FY),
	OP(CPU_DVFS_FREQ05_L_FY, CPU_DVFS_VOLT05_VPROC1_FY),
	OP(CPU_DVFS_FREQ06_L_FY, CPU_DVFS_VOLT06_VPROC1_FY),
	OP(CPU_DVFS_FREQ07_L_FY, CPU_DVFS_VOLT07_VPROC1_FY),
	OP(CPU_DVFS_FREQ08_L_FY, CPU_DVFS_VOLT08_VPROC1_FY),
	OP(CPU_DVFS_FREQ09_L_FY, CPU_DVFS_VOLT09_VPROC1_FY),
	OP(CPU_DVFS_FREQ10_L_FY, CPU_DVFS_VOLT10_VPROC1_FY),
	OP(CPU_DVFS_FREQ11_L_FY, CPU_DVFS_VOLT11_VPROC1_FY),
	OP(CPU_DVFS_FREQ12_L_FY, CPU_DVFS_VOLT12_VPROC1_FY),
	OP(CPU_DVFS_FREQ13_L_FY, CPU_DVFS_VOLT13_VPROC1_FY),
	OP(CPU_DVFS_FREQ14_L_FY, CPU_DVFS_VOLT14_VPROC1_FY),
	OP(CPU_DVFS_FREQ15_L_FY, CPU_DVFS_VOLT15_VPROC1_FY),
};

static struct mt_cpu_freq_info opp_tbl_B_e4_0[] = {
	OP(CPU_DVFS_FREQ00_B_FY0119, CPU_DVFS_VOLT00_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ01_B_FY0119, CPU_DVFS_VOLT01_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ02_B_FY0119, CPU_DVFS_VOLT02_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ03_B_FY0119, CPU_DVFS_VOLT03_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ04_B_FY0119, CPU_DVFS_VOLT04_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ05_B_FY0119, CPU_DVFS_VOLT05_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ06_B_FY0119, CPU_DVFS_VOLT06_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ07_B_FY0119, CPU_DVFS_VOLT07_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ08_B_FY0119, CPU_DVFS_VOLT08_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ09_B_FY0119, CPU_DVFS_VOLT09_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ10_B_FY0119, CPU_DVFS_VOLT10_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ11_B_FY0119, CPU_DVFS_VOLT11_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ12_B_FY0119, CPU_DVFS_VOLT12_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ13_B_FY0119, CPU_DVFS_VOLT13_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ14_B_FY0119, CPU_DVFS_VOLT14_VPROC2_FY0119),
	OP(CPU_DVFS_FREQ15_B_FY0119, CPU_DVFS_VOLT15_VPROC2_FY0119),
};

static struct mt_cpu_freq_info opp_tbl_CCI_e1_0[] = {
	OP(CPU_DVFS_FREQ00_CCI_FY, CPU_DVFS_VOLT00_VPROC1_FY),
	OP(CPU_DVFS_FREQ01_CCI_FY, CPU_DVFS_VOLT01_VPROC1_FY),
	OP(CPU_DVFS_FREQ02_CCI_FY, CPU_DVFS_VOLT02_VPROC1_FY),
	OP(CPU_DVFS_FREQ03_CCI_FY, CPU_DVFS_VOLT03_VPROC1_FY),
	OP(CPU_DVFS_FREQ04_CCI_FY, CPU_DVFS_VOLT04_VPROC1_FY),
	OP(CPU_DVFS_FREQ05_CCI_FY, CPU_DVFS_VOLT05_VPROC1_FY),
	OP(CPU_DVFS_FREQ06_CCI_FY, CPU_DVFS_VOLT06_VPROC1_FY),
	OP(CPU_DVFS_FREQ07_CCI_FY, CPU_DVFS_VOLT07_VPROC1_FY),
	OP(CPU_DVFS_FREQ08_CCI_FY, CPU_DVFS_VOLT08_VPROC1_FY),
	OP(CPU_DVFS_FREQ09_CCI_FY, CPU_DVFS_VOLT09_VPROC1_FY),
	OP(CPU_DVFS_FREQ10_CCI_FY, CPU_DVFS_VOLT10_VPROC1_FY),
	OP(CPU_DVFS_FREQ11_CCI_FY, CPU_DVFS_VOLT11_VPROC1_FY),
	OP(CPU_DVFS_FREQ12_CCI_FY, CPU_DVFS_VOLT12_VPROC1_FY),
	OP(CPU_DVFS_FREQ13_CCI_FY, CPU_DVFS_VOLT13_VPROC1_FY),
	OP(CPU_DVFS_FREQ14_CCI_FY, CPU_DVFS_VOLT14_VPROC1_FY),
	OP(CPU_DVFS_FREQ15_CCI_FY, CPU_DVFS_VOLT15_VPROC1_FY),
};

/* 16 steps OPP table*/
static struct mt_cpu_freq_method opp_tbl_method_LL_e1[] = {
	/* Target Frequency, POS, CLK */
	FP(CPU_DVFS_FREQ00_LL_FY,	1,	1),
	FP(CPU_DVFS_FREQ01_LL_FY,	1,	1),
	FP(CPU_DVFS_FREQ02_LL_FY,	1,	1),
	FP(CPU_DVFS_FREQ03_LL_FY,	1,	1),
	FP(CPU_DVFS_FREQ04_LL_FY,	1,	1),
	FP(CPU_DVFS_FREQ05_LL_FY,	1,	1),
	FP(CPU_DVFS_FREQ06_LL_FY,	2,	1),
	FP(CPU_DVFS_FREQ07_LL_FY,	2,	1),
	FP(CPU_DVFS_FREQ08_LL_FY,	2,	1),
	FP(CPU_DVFS_FREQ09_LL_FY,	2,	1),
...
static struct mt_cpu_freq_method opp_tbl_method_L_e1[] = {
	/* Target Frequency, POS, CLK */
	FP(CPU_DVFS_FREQ00_L_FY,	1,	1),
	FP(CPU_DVFS_FREQ01_L_FY,	1,	1),
	FP(CPU_DVFS_FREQ02_L_FY,	1,	1),
	FP(CPU_DVFS_FREQ03_L_FY,	1,	1),
	FP(CPU_DVFS_FREQ04_L_FY,	1,	1),
	FP(CPU_DVFS_FREQ05_L_FY,	1,	1),
	FP(CPU_DVFS_FREQ06_L_FY,	1,	1),
	FP(CPU_DVFS_FREQ07_L_FY,	1,	1),
	FP(CPU_DVFS_FREQ08_L_FY,	1,	1),
	FP(CPU_DVFS_FREQ09_L_FY,	2,	1),
...
static struct mt_cpu_freq_method opp_tbl_method_CCI_e1[] = {
	/* Target Frequency, POS, CLK */
	FP(CPU_DVFS_FREQ00_CCI_FY,	2,	1),
	FP(CPU_DVFS_FREQ01_CCI_FY,	2,	1),
	FP(CPU_DVFS_FREQ02_CCI_FY,	2,	1),
	FP(CPU_DVFS_FREQ03_CCI_FY,	2,	1),
	FP(CPU_DVFS_FREQ04_CCI_FY,	2,	1),
	FP(CPU_DVFS_FREQ05_CCI_FY,	2,	1),
	FP(CPU_DVFS_FREQ06_CCI_FY,	2,	1),
	FP(CPU_DVFS_FREQ07_CCI_FY,	2,	1),
	FP(CPU_DVFS_FREQ08_CCI_FY,	2,	2),
	FP(CPU_DVFS_FREQ09_CCI_FY,	2,	2),
...
static struct mt_cpu_freq_method opp_tbl_method_B_e4[] = {
	/* Target Frequency, POS, CLK */
	FP(CPU_DVFS_FREQ00_B_FY0119,	1,	1),
	FP(CPU_DVFS_FREQ01_B_FY0119,	1,	1),
	FP(CPU_DVFS_FREQ02_B_FY0119,	1,	1),
	FP(CPU_DVFS_FREQ03_B_FY0119,	1,	1),
	FP(CPU_DVFS_FREQ04_B_FY0119,	1,	1),
	FP(CPU_DVFS_FREQ05_B_FY0119,	1,	1),
	FP(CPU_DVFS_FREQ06_B_FY0119,	1,	1),
	FP(CPU_DVFS_FREQ07_B_FY0119,	1,	1),
	FP(CPU_DVFS_FREQ08_B_FY0119,	1,	1),
	FP(CPU_DVFS_FREQ09_B_FY0119,	1,	1),
...
static struct opp_tbl_info opp_tbls_0119[NR_MT_CPU_DVFS][1] = {
	/* LL */
	{
...
static struct opp_tbl_m_info opp_tbls_m_0119[NR_MT_CPU_DVFS][1] = {
	/* LL */
	{
...
static int _mt_cpufreq_init(struct cpufreq_policy *policy)
{
...

	{
		...
		printk("%s: code %d level %d seg %d\n",
			__func__, _mt_cpufreq_get_cpu_date_code(), lv, is_tt_segment);
...
static int _mt_cpufreq_pdrv_probe(struct platform_device *pdev)
{
	...
	for_each_cpu_dvfs(j, p) {
		...
		printk("%s: code %d level %d\n", __func__, _mt_cpufreq_get_cpu_date_code(), lv);
