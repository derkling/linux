...
static struct mt_gpufreq_table_info mt_gpufreq_opp_tbl_e1_0[] = {
	...
	GPUOP(GPU_DVFS_FREQ9, GPU_DVFS_VOLT14, 7),
};
...
static struct mt_gpufreq_table_info mt_gpufreq_opp_lp_tbl_e1_2[] = {
	...
	GPUOP(GPU_DVFS_FREQ9_M, GPU_DVFS_VOLT14, 7),
};
...
static void mt_gpufreq_clock_switch(unsigned int freq_new)
{
	...
	} else if (mt_gpufreq_dvfs_table_type == 1 || mt_gpufreq_dvfs_table_type == 5) {
		mt_gpufreq_clock_switch_transient(freq_new, POST_DIV2);
	} else if (mt_gpufreq_dvfs_table_type == 2 || mt_gpufreq_dvfs_table_type == 4 || mt_gpufreq_dvfs_table_type == 6) {
		if (freq_new >= 250000)
