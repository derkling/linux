...
#if SUPPORT_CHROME_VEA
{
	...
	memset(&cfg, 0, sizeof(struct v4l2_ctrl_config));
	cfg.ops = ops;
	cfg.id = V4L2_CID_MPEG_MFC51_VIDEO_FRAME_SKIP_MODE;
	cfg.name = "Skip frames";
	cfg.min = V4L2_MPEG_MFC51_VIDEO_FRAME_SKIP_MODE_DISABLED;
	cfg.max = V4L2_MPEG_MFC51_VIDEO_FRAME_SKIP_MODE_BUF_LIMIT;
	cfg.def = V4L2_MPEG_MFC51_VIDEO_FRAME_SKIP_MODE_DISABLED;
	cfg.type = V4L2_CTRL_TYPE_MENU;
	cfg.flags = 0;
	cfg.step = 0;
	cfg.menu_skip_mask = 0;
