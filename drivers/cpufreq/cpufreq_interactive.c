...
static int cpufreq_interactive_policy_init(struct cpufreq_policy *policy)
{
	int rc;
	struct cpufreq_interactive_tunables *tunables;
...
static void cpufreq_interactive_policy_exit(struct cpufreq_policy *policy)
{
	struct cpufreq_interactive_tunables *tunables;
...
static int cpufreq_interactive_policy_start(struct cpufreq_policy *policy)
{
	unsigned int j;
	struct cpufreq_interactive_cpuinfo *pcpu;
	struct cpufreq_frequency_table *freq_table;
...
static void cpufreq_interactive_policy_stop(struct cpufreq_policy *policy)
{
	unsigned int j;
	struct cpufreq_interactive_cpuinfo *pcpu;
...
static void cpufreq_interactive_policy_limits(struct cpufreq_policy *policy)
{
	unsigned int j;
	struct cpufreq_interactive_cpuinfo *pcpu;
	unsigned long flags;
...
static struct cpufreq_governor cpufreq_gov_interactive = {
	.name = "interactive",
	.init = cpufreq_interactive_policy_init,
	.exit = cpufreq_interactive_policy_exit,
	.start = cpufreq_interactive_policy_start,
	.stop = cpufreq_interactive_policy_stop,
	.limits = cpufreq_interactive_policy_limits,
