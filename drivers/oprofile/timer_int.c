...
{
	smp_call_function_single(cpu, __oprofile_hrtimer_start, NULL, 1);
	return 0;
}
...
{
	return cpuhp_setup_state_nocalls(CPUHP_OPROFILE_TIMER_ONLINE,
...
{
	cpuhp_remove_state_nocalls(CPUHP_OPROFILE_TIMER_ONLINE);
}
