 ...
 * Policy.
 */
void kbasep_js_policy_term_ctx(kbasep_js_policy *js_policy, struct kbase_context *kctx);
 ...
 */
void kbasep_js_policy_enqueue_ctx(kbasep_js_policy *js_policy, struct kbase_context *kctx);
 ...
 */
mali_bool kbasep_js_policy_dequeue_head_ctx(kbasep_js_policy *js_policy, struct kbase_context ** const kctx_ptr);
 ...
 */
mali_bool kbasep_js_policy_try_evict_ctx(kbasep_js_policy *js_policy, struct kbase_context *kctx);
 ...
 */
void kbasep_js_policy_foreach_ctx_job(kbasep_js_policy *js_policy, struct kbase_context *kctx,
 ...
 */
void kbasep_js_policy_runpool_add_ctx(kbasep_js_policy *js_policy, struct kbase_context *kctx);
 ...
 * Due to a spinlock being held, this function must not call any APIs that sleep.
 */
void kbasep_js_policy_runpool_remove_ctx(kbasep_js_policy *js_policy, struct kbase_context *kctx);
 ...
 */
mali_bool kbasep_js_policy_should_remove_ctx(kbasep_js_policy *js_policy, struct kbase_context *kctx);
 ...
 */
mali_bool kbasep_js_policy_ctx_has_priority(kbasep_js_policy *js_policy, struct kbase_context *current_ctx, struct kbase_context *new_ctx);
 ...
 */
mali_error kbasep_js_policy_init_job(const kbasep_js_policy *js_policy, const struct kbase_context *kctx, struct kbase_jd_atom *katom);
 ...
 */
void kbasep_js_policy_register_job(kbasep_js_policy *js_policy, struct kbase_context *kctx, struct kbase_jd_atom *katom);
 ...
 * - kbasep_js_kctx_info::ctx::jsctx_mutex will be held.
 */
void kbasep_js_policy_deregister_job(kbasep_js_policy *js_policy, struct kbase_context *kctx, struct kbase_jd_atom *katom);
 ...
 * - kbasep_js_kctx_info::ctx::jsctx_mutex will be held.
 */
void kbasep_js_policy_enqueue_job(kbasep_js_policy *js_policy, struct kbase_jd_atom *katom);
 ...
 */
void kbasep_js_policy_log_job_result(kbasep_js_policy *js_policy, struct kbase_jd_atom *katom, u64 time_spent_us);
