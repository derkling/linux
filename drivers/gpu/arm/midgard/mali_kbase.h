...
kbase_midgard_type kbase_device_get_type(struct kbase_device *kbdev);
...
void kbase_device_trace_register_access(struct kbase_context *kctx, kbase_reg_access_type type, u16 reg_offset, u32 reg_value);
...
void kbasep_trace_add(struct kbase_device *kbdev, kbase_trace_code code, void *ctx, struct kbase_jd_atom *katom, u64 gpu_addr, u8 flags, int refcount, int jobslot, unsigned long info_val);
