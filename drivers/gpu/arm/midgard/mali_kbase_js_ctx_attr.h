 ...
 * - runpool_irq spinlock
 */
static INLINE s8 kbasep_js_ctx_attr_count_on_runpool(struct kbase_device *kbdev, kbasep_js_ctx_attr attribute)
{
 ...
 * - runpool_irq spinlock
 */
static INLINE mali_bool kbasep_js_ctx_attr_is_attr_on_runpool(struct kbase_device *kbdev, kbasep_js_ctx_attr attribute)
{
 ...
 * - jsctx mutex
 */
static INLINE mali_bool kbasep_js_ctx_attr_is_attr_on_ctx(struct kbase_context *kctx, kbasep_js_ctx_attr attribute)
{
