...
#define GPU_THROTTLING_105_110  350
#define GPU_TRIPPING_110        350
...
/* GPU DVFS GOVERNOR */
#if SOC_NAME == 5422
#define G3D_GOVERNOR_DEFAULT_CLOCK_DEFAULT  350
#define G3D_GOVERNOR_DEFAULT_CLOCK_STATIC   350
#define G3D_GOVERNOR_STATIC_PERIOD          10
#define G3D_GOVERNOR_DEFAULT_CLOCK_BOOSTER  350
#elif SOC_NAME == 5430
...
#define GPU_DEFAULT_VOLTAGE		1050000
#elif SOC_NAME == 5430
