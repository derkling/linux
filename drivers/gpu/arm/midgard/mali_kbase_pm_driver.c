 ...
 */
STATIC void kbase_pm_invoke(struct kbase_device *kbdev, kbase_pm_core_type core_type, u64 cores, kbasep_pm_action action)
{
	u32 reg;
 ...
 */
static u64 kbase_pm_get_state(struct kbase_device *kbdev, kbase_pm_core_type core_type, kbasep_pm_action action)
{
	u32 reg;
	u32 lo, hi;
 ...
 */
STATIC mali_bool kbase_pm_transition_core_type(struct kbase_device *kbdev, kbase_pm_core_type type, u64 desired_state,
