...
void kbase_timeline_pm_check_handle_event(struct kbase_device *kbdev, kbase_timeline_pm_event event);

/** Check whether a pm event was present, and if so trace finishing it */
void kbase_timeline_pm_handle_event(struct kbase_device *kbdev, kbase_timeline_pm_event event);
...
static INLINE void kbase_timeline_pm_send_event(struct kbase_device *kbdev, kbase_timeline_pm_event event_sent)
{
}

static INLINE void kbase_timeline_pm_check_handle_event(struct kbase_device *kbdev, kbase_timeline_pm_event event)
{
}

static INLINE void kbase_timeline_pm_handle_event(struct kbase_device *kbdev, kbase_timeline_pm_event event)
{
}
