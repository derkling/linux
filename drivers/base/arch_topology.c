...
int topology_smt_flags(void)
{
	...
	if (share_cap == share_cap_thread)
		pr_info("topology_smt_flags: SD_SHARE_CAP_STATES\n");
	else
		pr_info("topology_smut_flags: !SD_SHARE_CAP_STATES\n");
...
int topology_core_flags(void)
{
	...
	if (share_cap == share_cap_core)
		pr_info("topology_core_flags: SD_SHARE_CAP_STATES\n");
	else
		pr_info("topology_core_flags: !SD_SHARE_CAP_STATES\n");
...
int topology_cpu_flags(void)
{
	...
	if (share_cap == share_cap_die)
		pr_info("topology_die_flags: SD_SHARE_CAP_STATES\n");
	else
		pr_info("topology_die_flags: !SD_SHARE_CAP_STATES\n");
