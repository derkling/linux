...
struct cpm_asm cpm_platform_asm[] = {
	[0] = CPM_PLATFORM_ASM("BANDWIDTH", CPM_TYPE_GIB, CPM_USER_RW, CPM_COMPOSITION_ADDITIVE, 0, 72),
};
...
struct cpm_dev_dwr buddy1_dwrs_list[] = {
	DEV_DWR(&buddy1.dev, 0, "dwr0", buddy1_dwr3_ranges, ARRAY_SIZE(buddy1_dwr3_ranges)),
	DEV_DWR(&buddy1.dev, 1, "dwr1", buddy1_dwr2_ranges, ARRAY_SIZE(buddy1_dwr2_ranges)),
	DEV_DWR(&buddy1.dev, 2, "dwr2", buddy1_dwr1_ranges, ARRAY_SIZE(buddy1_dwr1_ranges)),
	DEV_DWR(&buddy1.dev, 3, "dwr3", buddy1_dwr0_ranges, ARRAY_SIZE(buddy1_dwr0_ranges)),
};
