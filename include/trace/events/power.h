...
TRACE_EVENT(schedutil_em_boost,
	...
	TP_PROTO(unsigned int cpu, unsigned long util, unsigned int cost_margin,
		 unsigned int base_freq, unsigned int boosted_freq),

	TP_ARGS(cpu, util, cost_margin, base_freq, boosted_freq),
	...
	TP_printk("cpu=%u util=%lu cost_margin=%u base_freq=%u boosted_freq=%u",
		__entry->cpu, __entry->util, __entry->cost_margin,
