...
TRACE_EVENT(sched_find_best_target,
	...
	TP_ARGS(tsk, prefer_idle, min_util, best_idle, boosted,
	...
	TP_printk("pid=%d comm=%s prefer_idle=%d boosted=%d "
		  "best_idle=%d best_active=%d target=%d backup=%d",
		  __entry->pid, __entry->comm,
		  __entry->prefer_idle, __entry->boosted,
...
TRACE_EVENT_CONDITION(uclamp_se,
...
TRACE_EVENT_CONDITION(uclamp_cfs,
