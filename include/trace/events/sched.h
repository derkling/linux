...
TRACE_EVENT_CONDITION(uclamp_util_se,
	...
	TP_fast_assign(
		...
		__entry->uclamp_min     = uclamp_util(rq, UCLAMP_MIN);
		__entry->uclamp_max     = uclamp_util(rq, UCLAMP_MAX);
		),
...
TRACE_EVENT_CONDITION(uclamp_util_cfs,
	...
	TP_fast_assign(
		...
		__entry->uclamp_min     = uclamp_value(cpu_rq(cpu), UCLAMP_MIN);
		__entry->uclamp_max     = uclamp_value(cpu_rq(cpu), UCLAMP_MAX);
		),
