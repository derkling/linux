...
TRACE_EVENT(sched_util_est_task,
	...
	TP_STRUCT__entry(
		...
		__field( unsigned long,	est_enqueued		)
	...
	TP_printk("comm=%s pid=%d cpu=%d util_avg=%lu util_est_ewma=%lu util_est_enqueued=%lu",
		  __entry->comm,
		  __entry->pid,
		  __entry->cpu,
		  __entry->util_avg,
...
TRACE_EVENT(sched_util_est_cpu,
	...
	TP_STRUCT__entry(
		__field( int,		cpu			)
		__field( unsigned long,	util_avg		)
		__field( unsigned long,	util_est_enqueued	)
	),
	...
	TP_printk("cpu=%d util_avg=%lu util_est_enqueued=%lu",
		  __entry->cpu,
		  __entry->util_avg,
