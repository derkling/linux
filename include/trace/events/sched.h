...
TRACE_EVENT(sched_energy_diff,
	...
	TP_PROTO(int scpu, int dcpu, int udelta, int nrgb, int nrga, int nrgd, int capb, int capa, int capd, int nrgp),

	TP_ARGS(scpu, dcpu, udelta, nrgb, nrga, nrgd, capb, capa, capd, nrgp),
	...
	TP_printk("src_cpu=%d dst_cpu=%d usage_delta=%d "
			"nrg_before=%d nrg_after=%d nrg_diff=%d "
			"cap_before=%d cap_after=%d cap_diff=%d "
			"nrg_payoff=%d\n",
